...
(function (global, factory) {
  ...
  var ParsleyDefaults = {
    ...
    errorTemplate: '<li style="color:#dd4b39;"></li>'
  };
  ...
  ParsleyUI.Field = {
    ...
    _successClass: function _successClass() {
      ...
      this._ui.$errorClassHandler.removeClass(this.options.errorClass).parent().removeClass('has-error');
    },
    _errorClass: function _errorClass() {
      this._ui.validationInformationVisible = true;
      this._ui.$errorClassHandler.removeClass(this.options.successClass).addClass(this.options.errorClass);
      this._ui.$errorClassHandler.removeClass(this.options.successClass).parent().addClass('has-error');
    },
  ...
  Parsley.addMessages('en', {
    ...
    type: {
      email: "Este valor debe ser un email valido.",
      url: "Este valor debe ser una URL valida.",
      number: "Este valor debe ser un número valido.",
      integer: "Este valor debe ser un número entero valido.",
      digits: "Este valor debe ser compuesto por dígitos.",
      alphanum: "Este valor debe ser alfanumérico."
    },
    notblank: "Este valor no debe estar vacío.",
    required: "Este valor es requerido.",
    pattern: "Este valor parece ser invalido.",
    min: "Este valor debería ser mayor o igual a %s.",
    max: "Este valor debería ser menor o igual a %s.",
    range: "Este valor debería ser entre %s y %s.",
    minlength: "Este valor es muy corto. Debería tener %s caracteres o más.",
    maxlength: "Este valor es muy largo. Debería tener %s caracteres o menos.",
    length: "La longitud de este valor es invalida. Debería ser entre %s y %s caracteres.",
    mincheck: "Debes seleccionar al menos %s opciones.",
    maxcheck: "Debes seleccionar %s opciones o menos.",
    check: "Debería seleccionar entre %s y %s opciones.",
