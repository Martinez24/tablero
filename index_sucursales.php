...
<!--Aplicación de modal con Bootstrap -->
            <button class="btn btn-danger" data-toggle="modal" data-target="#miventana">Agregar Sucursales</button>
            </div>
                                ...
                                <div class="panel-body">
                                  <form method="post" action="sucursales.php" enctype="multipart/form-data" id="form">
                                    <div class="form-group">
                                      ...
                                      <input type="text" name="nombre" required id="nombre" placeholder="Ej: GPA " class="form-control" autofocus>
                                    </div>
...
<!Termina Formulario-->
            ...
            <div class="panel-body">
              <table class="table">
                ...
                <?php
                  ...
                  $sql = "SELECT s.id_sucursal, s.nombre as nombre, e.id_estado, e.estado as estado, s.telefono as telefono, s.direccion as direccion from sucursal s inner join estado e on e.id_estado = s.estado";
                  $resultado = mysql_query($sql, $conexion);
                  while ($sucursal = mysql_fetch_assoc($resultado)) {
                    echo "<tr>";
                    echo "<td><a href='sucursales.php?editar_sucursal_id=".$sucursal['id_sucursal']."' class='btn btn-rounded btn-primary editar-sucursal'><i class='fa fa-pencil'></i></a></td>";
                    echo "<td><a href='sucursales.php?eliminar_sucursal_id=".$sucursal['id_sucursal']."' class='btn btn-primary eliminar-sucursal'><i class='fa fa-trash eliminar-sucursal'></i></a></td>";
    ...
    <script type="text/javascript">
      $(document).ready(function(){
        $('.eliminar-sucursal').click(function(evt){
          evt.preventDefault();
          var url = $(this).attr('href');          
          if(confirm("¿Estás seguro de querer eliminar esta sucursal?")){
            console.log(url);
