              ...
              <div class="panel">
                ...
                <div class="panel-body">
                  <form method="post" action="maquinas.php" enctype="multipart/form-data" id="form">
                    <input type="hidden" name="maquina_id" value="<?php echo $maquina['id_maquina'];?>">
                    <div class="form-group">
                      <label for="nombre">Nombre de la máquina</label>
                      <input type="text" name="nombre" required id="nombre" placeholder="Ej: Shark Cut, Phanter Cut" class="form-control" value="<?php echo $maquina['nombre'];?>" autofocus>
                        </div>
                      <div class="form-group">
                        <label for="nombre">Modelo</label>
                          <input type="text" name="modelo" required id="Modelo" placeholder="" class="form-control" value="<?php echo $maquina['modelo'];?>" autofocus>
                      </div>
                    <div class="form-group">
