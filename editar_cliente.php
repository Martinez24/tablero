                ...
                <div class="panel-body">
                  <form method="post" action="clientes.php" enctype="multipart/form-data" id="form">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="nombre" required id="nombre" placeholder="Ej: Juan Solo" class="form-control" value="<?php echo $cliente['nombre'];?>" autofocus>
                    </div>
                     <div class="form-group">
                                     <dd>Estado:</dd>
                                    <dd>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="direccion" required id="direccion" placeholder="Ej: Mariano Escobedo #324, Olivos" class="form-control" value="<?php echo $cliente['direccion'];?>">
                    </div>
                    <div class="form-group">
                      <label for="empresa">Empresa</label>
                      <input type="text" name="empresa" required id="empresa" placeholder="Ej: Castores" class="form-control" value="<?php echo $cliente['empresa'];?>">
                    </div>
